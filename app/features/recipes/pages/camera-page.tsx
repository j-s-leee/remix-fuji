...
export default function CameraPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">{camera} 레시피</h1>

      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">카메라 정보</h2>
        <div className="bg-white rounded-lg shadow-md p-6">
          <p className="text-gray-600 mb-4">
            이 카메라에 대한 상세 설명이 들어갈 자리입니다.
          </p>
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-bold text-blue-500">567</div>
